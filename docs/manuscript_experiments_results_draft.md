# 5. Experiments and Results (draft)

A near-final single file for manuscript transfer (same §5 body with an assembly header) is `docs/manuscript_experiments_results_with_tables_figures.md`.
